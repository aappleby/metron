...
def build_parser():
    cpp_library(
        ...
        src_files=[
            ...
            "metron/parser/CNodeCall.cpp",
            "metron/parser/CNodeClass.cpp",
            "metron/parser/CNodeDeclaration.cpp",
            "metron/parser/CNodeExpression.cpp",
            "metron/parser/CNodeField.cpp",
            "metron/parser/CNodeFunction.cpp",
            "metron/parser/CNodeStatement.cpp",
            "metron/parser/CNodeStruct.cpp",
            "metron/parser/CNodeType.cpp",
