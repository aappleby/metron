...
def build_metron_lib():
    cpp_library(
        ...
        src_files=[
            ...
            "metron/CLexer.cpp",
            "metron/CNode.cpp",
            "metron/CNodeCall.cpp",
            "metron/CNodeClass.cpp",
            "metron/CNodeDeclaration.cpp",
            "metron/CNodeExpression.cpp",
            "metron/CNodeField.cpp",
            "metron/CNodeFunction.cpp",
            "metron/CNodeStatement.cpp",
            "metron/CNodeStruct.cpp",
            "metron/CNodeType.cpp",
            "metron/CParser.cpp",
            "metron/CScope.cpp",
