...
void GBSound::tick() {
  ...
  /*#p12.BYLE*/ wire BYLE_FREQ_OVERFLOW = nor2(ch1.ARYL_NR10_SWEEP_DIRn(), CORU_SUM10.carry);
  /*#p12.ATYS*/ wire ATYS_FREQ_OVERFLOW = or2(BYLE_FREQ_OVERFLOW, ch1.ARYL_NR10_SWEEP_DIRn());
