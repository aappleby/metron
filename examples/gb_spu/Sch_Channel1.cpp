...
void Channel1_tick(const Pins& pins,
  ...
  {
    /*_p09.AGUR*/ wire RESETn = not1(KEBA_APU_RSTp);
...

  {
    ...
    /*_p11.HATO*/ wire NR12_RSTn = not1(KEBA_APU_RSTp);
  ...
  // FF14 NR14
  {
    ...
    /*_p11.CAMY*/ wire NR14_RSTa = not1(KEBA_APU_RSTp);
    /*_p13.DADO*/ wire NR14_RSTb = nor4(KEBA_APU_RSTp, b.ch1.START);
...

  {
    ...
    /*_p09.ATYV*/ wire RESETo = not1(KEBA_APU_RSTp);
    ...
    /*_p13.BURY*/ wire SWEEP_TRIGGER_RSTn = nor4(NR10_NO_SWEEP, KEBA_APU_RSTp);
  ...
  {
    /*_p13.KABA*/ wire SUMMER_RST = or2(KEBA_APU_RSTp, b.ch1.RESTART0);
    ...
    /*_p12.EFOR*/ wire SUMMER00_RST = nor4(KEBA_APU_RSTp, /*_p12.EJYF*/ and2(FREQ_WRc, /*_p12.DEKE*/ not1(b.bus.TS_D0())));
    /*_p12.GATO*/ wire SUMMER01_RST = nor4(KEBA_APU_RSTp, /*_p12.FOPU*/ and2(FREQ_WRc, /*_p12.GULU*/ not1(b.bus.TS_D1())));
    /*_p12.GYFU*/ wire SUMMER02_RST = nor4(KEBA_APU_RSTp, /*_p12.FOKE*/ and2(FREQ_WRc, /*_p12.FULE*/ not1(b.bus.TS_D2())));
    /*_p12.GAMO*/ wire SUMMER03_RST = nor4(KEBA_APU_RSTp, /*_p12.FEGA*/ and2(FREQ_WRc, /*_p12.ETUV*/ not1(b.bus.TS_D3())));
    /*_p12.KAPO*/ wire SUMMER04_RST = nor4(KEBA_APU_RSTp, /*_p12.KAVO*/ and2(FREQ_WRc, /*_p12.KOPU*/ not1(b.bus.TS_D4())));
    /*_p12.KAJU*/ wire SUMMER05_RST = nor4(KEBA_APU_RSTp, /*_p12.KYFU*/ and2(FREQ_WRc, /*_p12.JULO*/ not1(b.bus.TS_D5())));
    /*_p12.ELUF*/ wire SUMMER06_RST = nor4(KEBA_APU_RSTp, /*_p12.ETOK*/ and2(FREQ_WRc, /*_p12.DYLU*/ not1(b.bus.TS_D6())));
    /*_p12.ESEL*/ wire SUMMER07_RST = nor4(KEBA_APU_RSTp, /*_p12.EMAR*/ and2(FREQ_WRc, /*_p12.DULO*/ not1(b.bus.TS_D7())));
    /*_p12.BOXU*/ wire SUMMER08_RST = nor4(KEBA_APU_RSTp, /*_p12.BASO*/ and2(FREQ_WRb, /*_p12.BYSU*/ not1(b.bus.TS_D0())));
    /*_p12.BOVU*/ wire SUMMER09_RST = nor4(KEBA_APU_RSTp, /*_p12.AMAC*/ and2(FREQ_WRb, /*_p12.BOFU*/ not1(b.bus.TS_D1())));
    /*_p12.APAJ*/ wire SUMMER10_RST = nor4(KEBA_APU_RSTp, /*_p12.AJUX*/ and2(FREQ_WRb, /*_p12.BYFU*/ not1(b.bus.TS_D2())));
...

  {
    ...
    /*_p13.EPUK*/ wire EPUK = nor4(b.ch1.SHIFT_DONE_SYNC, KEBA_APU_RSTp);
    ...
    /*_p13.ATAT*/ next.ch1.SHIFT_DONE_SYNC_RST = nor4(KEBA_APU_RSTp, b.ch1.SWEEP_TRIGGER);
...

  {
    ...
    /*_p12.JADO*/ wire SHIFTER_RST_00 = nor4(KEBA_APU_RSTp, KOKO);
    /*_p12.HOBU*/ wire SHIFTER_RST_01 = nor4(KEBA_APU_RSTp, JOCY);
    /*_p12.HYVU*/ wire SHIFTER_RST_02 = nor4(KEBA_APU_RSTp, JEHY);
    /*_p12.KETO*/ wire SHIFTER_RST_03 = nor4(KEBA_APU_RSTp, KAXY);
    /*_p12.KYBO*/ wire SHIFTER_RST_04 = nor4(KEBA_APU_RSTp, KEVY);
    /*_p12.EZUK*/ wire SHIFTER_RST_05 = nor4(KEBA_APU_RSTp, EVOF);
    /*_p12.ENOK*/ wire SHIFTER_RST_06 = nor4(KEBA_APU_RSTp, EREG);
    /*_p12.BEWO*/ wire SHIFTER_RST_07 = nor4(KEBA_APU_RSTp, BAPU);
    /*_p12.AGOR*/ wire SHIFTER_RST_08 = nor4(KEBA_APU_RSTp, AFUG);
    /*_p12.AFUX*/ wire SHIFTER_RST_09 = nor4(KEBA_APU_RSTp, BUVO);
    /*_p12.AVUF*/ wire SHIFTER_RST_10 = nor4(KEBA_APU_RSTp, AFYR);
...

  {
    ...
    /*_p13.CAPY*/     wire CAPY_CH1_LEN_CLKn = nor3(bCLK_256, !b.ch1.NR14_STOP, b.ch1.CH1_LEN_DONE); // use_len polarity?
    ...
    /*_p13.CORY*/   next.ch1.CH1_LEN_DONE_RST = nor4(b.ch1.RESTART0, KEBA_APU_RSTp, b.ch1.FF11_WRb);
...

  {
    ...
    /*_p13.EZEC*/ next.ch1.START = tock_pos(aCLK_1M, bCLK_1M, /*_p13.DUKA*/ not1(KEBA_APU_RSTp), b.ch1.START, b.ch1.NR14_START);


    /*_p13.GEFE*/ next.ch1.RESTART0_RSTn = not1(/*_p13.EGET*/ nor4(KEBA_APU_RSTp, b.ch1.RESTART1));
    /*_p13.ERUM*/ next.ch1.RESTART_RSTo = not1(KEBA_APU_RSTp);
...

  {
    ...
    /*_p13.DYRU*/ wire PHASE_CLK_RST = nor4(KEBA_APU_RSTp, b.ch1.RESTART0, /*_p13.DOKA*/ and2(b.ch1.PHASE_CLKnb, b.ch1.RESTART_CLKn));
    ...
    // weird latch?
    /*_p13.GEXU*/ next.ch1.FREQ_GATE = or2(/*_p13.FEMY*/ nor4(b.ch1.CH1_AMP_ENn, KEBA_APU_RSTp), /*_p13.GEPU*/ not1(b.ch1.RESTART2));
...

  {
    ...
    /*_p13.KALY*/ next.ch1.CLK_64a  = tock_pos(a.ch1.CLK_128n, b.ch1.CLK_128n, /*_p13.KADO*/ not1(KEBA_APU_RSTp), b.ch1.CLK_64a, !b.ch1.CLK_64a);
    ...
    /*_p13.KYNO*/ next.ch1.ENV_STOP = tock_pos(a.ch1.ENV_CLK, b.ch1.ENV_CLK, /*_p13.KORU*/ nor4(b.ch1.RESTART0, KEBA_APU_RSTp), b.ch1.ENV_STOP, ENV_MAX);

    /*_p13.KEKO*/ wire KEKO = or2(KEBA_APU_RSTp, b.ch1.RESTART0);
