...
void P14_Ch2Regs_tick(const Gameboy& a,
  ...
  /*_p14.HUDE*/ next.ch2.APU_RESETn1 = not1(KEBA_APU_RSTp);

  /*_p14.JYBU*/ next.ch2.JYBU = not1(KEBA_APU_RSTp);
  /*_p14.KYPU*/ next.ch2.KYPU = not1(KEBA_APU_RSTp);
  /*_p14.FAZO*/ next.ch2.FAZO = not1(KEBA_APU_RSTp);
  /*_p15.KATY*/ next.ch2.KATY = not1(KEBA_APU_RSTp);
  /*_p15.CYWU*/ next.ch2.CYWU = not1(KEBA_APU_RSTp);
  /*_p15.CEXE*/ next.ch2.CEXE = not1(KEBA_APU_RSTp);
  /*_p15.BUWE*/ next.ch2.BUWE = not1(KEBA_APU_RSTp);
...

  {
    ...
    /*_p14.BENY*/ next.ch2.BENY = nor4(b.ch2.ASYP, KEBA_APU_RSTp, b.ch2.ELOX);
    /*_p14.BACU*/ next.ch2.BACU = and2(ADDR_FF16, b.apu.APU_WR);
    /*_p14.BUDU*/ next.ch2.BUDU = not1(b.ch2.BACU);

    {
      /*_p09.AFAT*/ wire APU_RESETn = not1(KEBA_APU_RSTp);
  ...
  /*_p15.DOXA*/ next.ch2.DOXA = or2(KEBA_APU_RSTp, b.ch2.DORY);
  ...
  /*_p15.GYRE*/ next.ch2.GYRE = nor4(KEBA_APU_RSTp, b.ch2.ELOX, b.ch2.FUJY);
  ...
  /*_p15.DERA*/ next.ch2.DERA = nor4(KEBA_APU_RSTp, b.ch2.DOPE);

  // weird latch?
  /*_p15.DALA*/ next.ch2.DALA = or2(b.ch2.CELO, b.ch2.DOPE);
  /*_p15.CELO*/ next.ch2.CELO = not1(b.ch2.DOXA);
  /*_p15.HYLE*/ next.ch2.HYLE = or2(KEBA_APU_RSTp, b.ch2.ELOX);
  /*_p15.HYPA*/ next.ch2.HYPA = nor4(b.ch2.ELOX, KEBA_APU_RSTp);
  ...
  /*_p15.ESYK*/ next.ch2.ESYK = or2(KEBA_APU_RSTp, b.ch2.DORA, b.ch2.CH2_AMP_ENn);
  /*_p15.ARES*/ next.ch2.ARES = nand2(KEBA_APU_RSTp, b.ch2.CH2_AMP_ENn);
  ...
  /*_p15.HAFE*/ next.ch2.HAFE = or2(b.ch2.HOLY, b.ch2.ELOX, KEBA_APU_RSTp);
