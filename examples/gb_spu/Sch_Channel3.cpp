...
void P16_Ch3Regs_tick(const ClkSignals& clk_reg,
...

  {
    ...
    /*_p16.GOVE*/ wire APU_RESETo = not1(KEBA_APU_RSTp);
...

  {
    ...
    /*_p18.GUDA*/ wire GUDA = nor4(GETO, KEBA_APU_RSTp, b.ch3.GARA);
...

  {
    ...
    /*_p16.GURO*/ wire APU_RESETn = not1(KEBA_APU_RSTp);
...

  {
    ...
    /*_p16.KUHA*/ next.ch3.APU_RESETq = not1(KEBA_APU_RSTp);
...

  {
    ...
    /*_p16.KOPY*/ wire APU_RESETs  = not1(KEBA_APU_RSTp);
    /*_p16.HEKY*/ wire APU_RESETr  = not1(KEBA_APU_RSTp);
    /*_p16.FAKO*/ wire RESTART_RST = nor4(KEBA_APU_RSTp, b.ch3.CH3_RESTART_SYNC);
  ...
  {
    /*_p16.FURY*/ wire APU_RESETn = nor4(b.ch3.GYTA, KEBA_APU_RSTp);
    /*_p16.GULO*/ wire GULO = not1(APU_RESETn);

    // weird latch?
    /*_p16.GOFY*/ wire GOFY = or2(GULO, b.ch3.CH3_RESTART_SYNC);

    /*_p16.GAZE*/ wire APU_RESETo = not1(KEBA_APU_RSTp);
...

  {
    ...
    /*_p16.FUVO*/ wire FUVO = nor4(b.ch3.CH3_AMP_ENna, KEBA_APU_RSTp);
...

  {
    ...
    /*_p18.GAFU*/ wire GAFU = nor4(KEBA_APU_RSTp, b.ch3.GARA, HUPA);
    ...
    /*_p18.GYRY*/ wire LOOP_RST = nor4(KEBA_APU_RSTp, b.ch3.GARA, FOTO);
  ...
  {
    /*_p16.GOMA*/ wire APU_RESETn = not1(KEBA_APU_RSTp);
...

  {
    ...
    /*_p18.FYGO*/ next.ch3.FYGO = or2(KEBA_APU_RSTp, b.ch3.GEDO, b.ch3.CH3_AMP_ENna);
  ...
  //----------
  {
    /*_p17.ACOR*/ wire APU_RESETv = not1(KEBA_APU_RSTp);
    /*_p17.BUTU*/ wire SAMPLE_CLK = not1(b.ch3.SAMPLE_CLKn);
