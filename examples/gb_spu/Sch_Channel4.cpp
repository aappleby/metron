...
void Channel4::tick(logic<16> addr) {
  ...
  wire ADDR_0xxx = (addr & 0b1000) == 0b0000;
  wire ADDR_x0xx = (addr & 0b0100) == 0b0000;
  wire ADDR_xx0x = (addr & 0b0010) == 0b0000;
  wire ADDR_xxx0 = (addr & 0b0001) == 0b0000;
  ...
  {
    /*_p10.DONA*/ wire DONA_ADDR_0000bn = nand4(ADDR_0xxx, ADDR_x0xx, ADDR_xx0x, ADDR_xxx0);
    /*_p10.DANU*/ wire DANU_FF20a    = nor2(ADDR_FF2Xn, ADDR_0000bn);
    /*_p19.CAZE*/ wire CAZE_FF20_WRn = nand2(APU_WR, DANU_FF20a);
    /*_p19.FURU*/ wire FURU_FF20_WRa = not1(CAZE_FF20_WRn);
    /*_p19.DOTU*/ wire DOTU_FF20_WRb = not1(CAZE_FF20_WRn);
    /*_p19.EPEK*/ wire EPEK_FF20_WRc = not1(CAZE_FF20_WRn);

    /*_p09.KUBY*/ wire KUBY_RSTn = not1(APU_RST);
    /*_p09.KEBA*/ wire KEBA_RSTa = not1(KUBY_RSTn);
    /*_p19.GAPY*/ wire GAPY_LEN_RSTn = nor3(FURU_FF20_WRa, KEBA_RSTa, GONE_RESTART1);

    // doda = nor3(FUGO.qp_new(), BUFY_CLK_256, CUNY_NR44_STOP)
    ...
    */
    ...
    // cuny04 << COMP CLOCK
    // cuny06 << CABE_RSTn
    // cuny = dff9(DULU_FF23_WRn, CABE_RSTn, BUS_D6)


    /*_p19.DODA*/ wire DODA_LEN_CLKn = nor3(FUGO_LEN_STOP.qp_new(), BUFY_CLK_256, CUNY_NR44_STOP.qp_new());
    /*_p19.CUWA*/ wire CUWA_LEN_CLKa = not1(DODA_LEN_CLKn);
    /*_p19.DOPU*/ wire DOPU_NR41_LEN3b = not1(CEDO_NR41_LEN3.qp_new());

    #if 0
    /*_p19.DANO*/ DANO_NR41_LEN0  = count_pos(CUWA_LEN_CLKa,   DOTU_FF20_WRb, BUS_D0);
    /*_p19.FAVY*/ FAVY_NR41_LEN1  = count_pos(DANO_NR41_LEN0,  DOTU_FF20_WRb, BUS_D1);
    /*_p19.DENA*/ DENA_NR41_LEN2  = count_pos(FAVY_NR41_LEN1,  DOTU_FF20_WRb, BUS_D2);
    /*_p19.CEDO*/ CEDO_NR41_LEN3  = count_pos(DENA.NR41_LEN2,  DOTU_FF20_WRb, BUS_D3);
    /*_p19.FYLO*/ FYLO_NR41_LEN4  = count_pos(DOPU_NR41_LEN3b, EPEK_FF20_WRc, BUS_D4);
    /*_p19.EDOP*/ EDOP_NR41_LEN5  = count_pos(FYLO_NR41_LEN4,  EPEK_FF20_WRc, BUS_D5);
    ...
    fugo02 << EDOP18?
    fugo06 << GAPY
    fugo07 << fugo16 fugo.QN
    

    */

    /*_p19.FUGO*/ FUGO_LEN_STOP.dff17(EDOP, GAPY, wire FUGO_LEN_STOP.qn_old());
    #endif
  ...
  {
    /*_p10.DEWA*/ wire ADDR_0001bn = nand2(ADDR_0xxx, ADDR_x0xx, ADDR_xx0x, ADDR_xxx1);
    /*_p10.COVO*/ wire FF21a    = nor4(ADDR_FF2Xn, ADDR_0001bn);
    /*_p19.BOFY*/ wire FF21n    = not1(FF21a);
    /*_p19.GONY*/ wire FF21o    = not1(FF21a);
    /*_p19.DACO*/ wire FF21_WRa = and2(APU_WR, FF21a);
    /*_p19.GOKO*/ wire FF21_WRb = and2(APU_WR, FF21a);
    ...
    /*_p09.KUBY*/ wire RSTn = not1(APU_RST);
  ...
  {
    /*_p10.DOFA*/ wire ADDR_0010bn = nand2(ADDR_0xxx, ADDR_x0xx, ADDR_xx1x, ADDR_xxx0);
    /*_p10.EKEZ*/ wire FF22a = nor4(ADDR_FF2Xn, ADDR_0010bn);
    /*_p19.KOKU*/ wire FF22n = not1(FF22a);
    /*_p19.GUGO*/ wire FF22o = not1(FF22a);

    /*_p19.HUMO*/ wire FF22_WRa = and2(FF22a, APU_WR);
    /*_p19.GETU*/ wire FF22_WRn = nand2(FF22a, APU_WR);
    ...
    /*_p19.HOSO*/ next.ch4.FF22_WRp = nand2(FF22a, APU_WR);
...

  {
    ...
    /*_p10.DUFE*/ wire ADDR_0011bn = nand2(ADDR_0xxx, ADDR_x0xx, ADDR_xx1x, ADDR_xxx1);

    /*_p10.CUGE*/ wire FF23a    = nor4(ADDR_FF2Xn, ADDR_0011bn);
    /*_p19.BARE*/ wire FF23_RDa = nand2(FF23a, CPU_RDb); // polarity?

    /*_p09.KUBY*/ wire KUBY_RSTn = not1(APU_RSTp);
    /*_p09.KEBA*/ wire KEBA_RSTp = not1(KUBY_RSTn);
    /*_p19.CABE*/ wire CABE_RSTn = not1(KEBA_RSTp);

    /*_p16.ANUJ*/ wire CPU_WR_WEIRD = and2(b.cpu.SIG_CPU_HOLD_MEM, APU_WR);
    /*_p19.DULU*/ DULU_FF23_WRn = nand2(CPU_WR_WEIRD, FF23a);
    /*_p19.CUNY*/ CUNY_NR44_STOP  = tock_pos(a.ch4.FF23_WRn, b.ch4.FF23_WRn, RSTs, b.ch4.NR44_STOP,  b.bus.TS_D6());

    /*_p20.GUZY*/ wire NR44_START_RST = nor4(b.ch4.CH4_START, RSTa);
    /*_p19.FOXE*/ FOXE_FF23_WRo = nand2(APU_WR, FF23a);
    /*_p19.HOGA*/ HOGA_NR44_START = tock_pos(a.ch4.FF23_WRo, b.ch4.FF23_WRo, NR44_START_RST, b.ch4.NR44_START, b.bus.TS_D7());
...

  {
    ...
    /*_p20.GONE*/ next.ch4.RESTART1 = tock_pos(a.apu.CLK_512Kn, CLK_512Kn, RESTART_RSTn, b.ch4.RESTART1, RESTART_IN);
    /*_p20.GORA*/ next.ch4.RESTART2 = tock_pos(a.apu.CLK_512Kn, CLK_512Kn, RSTt,         b.ch4.RESTART2, b.ch4.RESTART1);
    /*_p20.GATY*/ next.ch4.RESTART3 = tock_pos(a.apu.CLK_512Kn, CLK_512Kn, RSTt,         b.ch4.RESTART3, b.ch4.RESTART2);
    ...
    /*_p20.KYKU*/ wire DIV_CLKb  = nor4(CLK_512Ka, DIV_GATE3); // schematic wrong
...

  {
    ...
    /*_p20.DYRY*/ next.ch4.DBG_CH4 = and2(NR44_STOPn, NR52_DBG_APU);
...

  {
    ...
    /*_p20.GYBA*/ next.ch4.FREQ_GATE_CLK  = not1(BAVU_1M);
    ...
    /*_p20.CARY*/ next.ch4.FREQ_CLK = and2(BAVU_1M, b.ch4.FREQ_GATEn);
...

  {
    ...
    /*_p20.ALOP*/ next.ch4.CLK_128n = not1(CLK_128a);
    ...
    /*_p20.HURY*/ wire ENV_PULSE_RST1 = nor4(CLK_512a, ENV_PULSEn);
    ...
    /*_p20.FOSY*/ next.ch4.ENV_PULSE    = tock_pos(a.apu.CLK_512a, CLK_512a, ENV_PULSE_RST2, b.ch4.ENV_PULSE, ENV_TIMER_MAX);
...

  {
    ...
    /*_p20.CEPY*/ wire NR44_STOPn = not1(b.ch4.NR44_STOP);
    /*_p20.COTE*/ wire DBG_CH4_MUTE = and2(NR44_STOPn,  NR52_DBG_APU);
