...
VL_ATTR_COLD void Vtoplevel___024root___ctor_var_reset(Vtoplevel___024root* vlSelf) {
    ...
    vlSelf->toplevel__DOT__unnamedblk2__DOT__unnamedblk4__DOT__rdata = VL_RAND_RESET_I(32);
    ...
    vlSelf->toplevel__DOT__unnamedblk2__DOT__unnamedblk5__DOT__wdata = VL_RAND_RESET_I(32);
