...
VL_ATTR_COLD void Vuart_top___024root___ctor_var_reset(Vuart_top___024root* vlSelf) {
    ...
    vlSelf->tock_serial = VL_RAND_RESET_I(1);
    vlSelf->tock_data = VL_RAND_RESET_I(8);
    vlSelf->tock_valid = VL_RAND_RESET_I(1);
    vlSelf->tock_done = VL_RAND_RESET_I(1);
    vlSelf->tock_sum = VL_RAND_RESET_I(32);
    vlSelf->uart_top__DOT__tx_tock_i_data = VL_RAND_RESET_I(8);
    vlSelf->uart_top__DOT__tx_tock_i_req = VL_RAND_RESET_I(1);
    vlSelf->uart_top__DOT__tx_tock_idle = VL_RAND_RESET_I(1);
    ...
    vlSelf->uart_top__DOT__tx__DOT__unnamedblk1__DOT__cycle_max = VL_RAND_RESET_I(2);
    vlSelf->uart_top__DOT__tx__DOT__unnamedblk1__DOT__cursor_max = VL_RAND_RESET_I(5);
    ...
    vlSelf->uart_top__DOT__rx__DOT__unnamedblk1__DOT__temp = VL_RAND_RESET_I(8);
}
