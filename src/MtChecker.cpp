...
CHECK_RETURN Err MtChecker::merge_branch(StateMap & ma, StateMap & mb, StateMap & out) {
  Err err;
...
CHECK_RETURN Err MtChecker::trace_component_call(const std::string& component_name, MtModule* dst_module, MtMethod* dst_method) {
  Err err;
...
CHECK_RETURN Err MtChecker::trace_read(MtField* field, MtField* component_field) {
  Err err;
...
CHECK_RETURN Err MtChecker::trace_write(MtField* field, MtField* component_field) {
  Err err;
