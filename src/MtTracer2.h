...
public:
  ...
  CHECK_RETURN Err log_action(MtMethodInstance* method, MnNode node, MtInstance* field_inst, TraceAction action);
  ...
  CHECK_RETURN Err trace_sym_function_definition   (MtCallInstance* call_inst, MnNode node);
