...
VL_INLINE_OPT void Vbasic_lockstep2___024root___sequent__TOP__0(Vbasic_lockstep2___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbasic_lockstep2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbasic_lockstep2___024root___sequent__TOP__0\n"); );
    // Init
...
void Vbasic_lockstep2___024root___eval(Vbasic_lockstep2___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbasic_lockstep2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbasic_lockstep2___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clock) & (~ (IData)(vlSelf->__Vclklast__TOP__clock)))) {
        Vbasic_lockstep2___024root___sequent__TOP__0(vlSelf);
    }
    // Final
...
void Vbasic_lockstep2___024root___eval_debug_assertions(Vbasic_lockstep2___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbasic_lockstep2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbasic_lockstep2___024root___eval_debug_assertions\n"); );
    // Body
